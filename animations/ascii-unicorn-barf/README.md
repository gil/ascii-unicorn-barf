...
Serve the repo root and open `/animations/ascii-unicorn-barf/`:

```sh
python3 -m http.server
# then visit http://localhost:8000/animations/ascii-unicorn-barf/
```

Opening `index.html` straight from disk works too, unless your browser blocks
WebGL or scripts on `file://`.
